# Trip Tide – Airbnb Clone 🏡

A beginner‑friendly backend project built with **Node.js**, **Express.js**, and **MongoDB** following the **MVC design pattern**.
This project is inspired by Airbnb and focuses on learning and implementing core backend concepts such as authentication, CRUD operations, validations, and image storage.

🔗 **Live:** [trip-tide-project.onrender.com](https://trip-tide-project.onrender.com/)
...
- **Templating:** EJS (for views if needed)
...
```bash
git clone https://github.com/sonukumar-dev04/Trip-Tide-Airbnb-clone-.git
cd Trip-Tide-Airbnb-clone-
npm install
npm start
```

Set up your `.env` with MongoDB URI and Cloudinary credentials.
